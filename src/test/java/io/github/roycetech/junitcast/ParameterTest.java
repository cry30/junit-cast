...
public class ParameterTest
		extends AbstractTransientValueTestCase<Parameter<String>, String, Object> {
	...
	protected void setupTargetObject(final List<Object> constructorParams)
	{
		prepare();
		try {
			new MockitoHelper().setupTargetObject(this,
					Arrays.asList(new Object[] { getTransientValue(ConstructorParameter.CaseDesc),
	...
	{
		return new ParameterGenerator<String>().genVarData("io.github.roycetech.junitcast.ParameterTest");
	}
	...
	protected void prepare()
	{
		...
		source.addTransientCase(ConstructorParameter.Scenario,
				Arrays.asList(new String[] { "scen1" }), Variable.one_scenario);

		source.addTransientCase(ConstructorParameter.Scenario,
				Arrays.asList(new String[] { "scen1", "scen2", "scen3" }), Variable.three_scenario);

		source.addTransientCase(ConstructorParameter.Result, Variable.has_result + "1",
				Variable.has_result);

		source.addTransientCase(ConstructorParameter.Identifier,
				Arrays.asList(new String[] { Variable.has_id + "2" }), Variable.has_id);
