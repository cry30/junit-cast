 ...
 */
public class PositivityTest extends AbstractTransientValueTestCase<Positivity, Integer, Integer> {

	/**
	 * @param pParameter Data Transfer Object Parameter in Parameterized test.
	 */
	public PositivityTest(final Parameter<Integer> pParameter) {
		super(pParameter);
	}
	...
	public static Collection<Object[]> generateData() {
		return new ParameterGenerator<Integer>().genVarData("io.github.roycetech.junitcast.example.PositivityTest");
	}
